...
//set event binding on the grid so we can select using the up/down keys
    ...
    var ngColumn = function (config, $scope, grid, domUtilityService, $templateCache, $utils) {
        ...
        self.showSortButtonUp = function() {
            return self.sortable ? true: false;
        };
...
/// <reference path="../../lib/jquery-1.8.2.min" />
    var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
        ...
        self.sortColumnsInit = function() {
            ...
            angular.forEach($scope.columns, function(c) {
                ...
                if (i !== -1) {
                    c.sortDirection = self.config.sortInfo.directions[i] || 'desc';
                    cols[i] = c;
                }
            });
    ...
    window.ngGrid.i18n['en'] = {
        ...
        ngSelectedItemsLabel: '已选择:',
        ngPageSizeLabel: '每页显示:',
        ngPagerFirstTitle: '第一页',
    ...
    window.ngGrid.i18n['fa'] = {
        ...
        ngMenuText: 'Ø§Ù†ØªØ®Ø§Ø¨ Ø³ØªÙˆÙ†\u200cÙ‡Ø§:',
        ngShowingItemsLabel: 'Ù†Ù…Ø§ÛŒØ´ Ù…ÙˆØ±Ø¯Ù‡Ø§:',
        ngTotalItemsLabel: 'Ù‡Ù…Ù‡Ù” Ù…ÙˆØ±Ø¯Ù‡Ø§:',
        ngSelectedItemsLabel: 'Ù…ÙˆØ±Ø¯Ù‡Ø§ÛŒ Ø§Ù†ØªØ®Ø§Ø¨\u200cØ´Ø¯Ù‡:',
    ...
    angular.module('ngGrid').run(['$templateCache', function($templateCache) {
        ...
        $templateCache.put('headerCellTemplate.html',
                ...
                "\n" +
                "    <div class=\"ngSortButtonDown\" ng-class=\"{'ngSortButtonCur':col.sortDirection==='asc'}\"     ng-click=\"col.sort($event)\"     ng-show=\"col.showSortButtonDown()\"></div>\r" +
                "\n" +
                "    <div class=\"ngSortButtonUp\"  ng-class=\"{'ngSortButtonCur':col.sortDirection==='desc'}\" ng-click=\"col.sort($event)\" ng-show=\"col.showSortButtonUp()\"></div>\r" +
                "\n" +
