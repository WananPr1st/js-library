      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , resetToMinDate = function resetToMinDate() {
            ...
            $scope.month = $filter('date')(new Date($scope.dateMinLimit), 'MM');
          ...
          , resetToMaxDate = function resetToMaxDate() {
            ...
            $scope.month = $filter('date')(new Date($scope.dateMaxLimit), 'MM');
        ...
        $scope.nextMonth = function nextMonth() {
          ...
          //set next month
          $scope.month = $filter('date')(new Date($scope.year, $scope.monthNumber - 1), 'MM');
          //reinit days
          setDaysInMonth($scope.monthNumber, $scope.year);
