            ...
            jqrotatezoom: function(options) {
                ...
                return this.each(function() {
                    ...
                    function addEvent() {
                        ...
                        me.off('mouseleave mouseout');
                        me.on('mouseleave mouseout', function (event) {
                            curOptions.zoomDiv.hide();
                        });
                        curOptions.rotateZoomDiv.on('mouseleave mouseout', function (event) {
                            curOptions.zoomDiv.hide();
                        });
                    }
                    ...
                    function zoomRender() {
                        ...
                        var smallImg = curOptions.smallImg;
                        var smallImgHeight = smallImg[0].naturalHeight || smallImg.outerHeight();
                        var smallImgWidth = smallImg[0].naturalWidth || smallImg.outerWidth();
                        div.css({
                            // top: curOptions.parentNodeHeight / 2 - smallImgHeight / 2,
                            // left: curOptions.parentNodeWidth / 2 - curOptions.smallImg.outerWidth() / 2,
                            height: smallImgHeight,
                            width: smallImgWidth,
                            top: curOptions.parentNodeHeight / 2,
                            marginTop: -smallImgHeight / 2,
                            left: curOptions.parentNodeWidth / 2,
                            marginLeft: - smallImgWidth / 2
                        });
                    }
                    ...
                    function widgetRender() {
                        ...
                        if (curOptions.isExist) {
                            ...
                            var rotateIconTop;
                            if (curOptions.rotatePosition) {
                                // 正上方
                                rotateIconTop = curOptions.parentNodeHeight / 2 - smallImgHeight / 2 - 30;
                            } else {
                                rotateIconTop =
                                    curOptions.parentNodeHeight - smallImgHeight > 60
                                    ? curOptions.parentNodeHeight / 2 - smallImgHeight / 2 - 30
                                    : 0;
                            }
                            optDiv.css({
                                top: rotateIconTop,
